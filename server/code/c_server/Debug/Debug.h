...
#define DEBUG_POS printf("\n-->%s:%d: [%s]\n", __FILE__,__LINE__,__FUNCTION__);

extern int config;

// DEBUG_D输出
#define DEBUG_D(format, ...) {if (3<config) {printf("DEBUG_D: "#format, ##__VA_ARGS__);DEBUG_POS}}

// DEBUG_I输出
#define DEBUG_I(format, ...) {if (2<config) {printf("DEBUG_I: "#format, ##__VA_ARGS__);DEBUG_POS}}

// DEBUG_W输出
#define DEBUG_W(format, ...) {if (1<config) {printf("DEBUG_W: "#format, ##__VA_ARGS__);DEBUG_POS}}

// DEBUG_E输出
#define DEBUG_E(format, ...) {if (0<config) {printf("DEBUG_E: "#format, ##__VA_ARGS__);DEBUG_POS}}
