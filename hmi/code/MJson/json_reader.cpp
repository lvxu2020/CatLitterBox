...
bool CharReaderBuilder::validate(MJson::Value* invalid) const {
    MJson::Value my_invalid;
    if (!invalid)
        invalid = &my_invalid; // so we do not need to test for NULL
    MJson::Value& inv = *invalid;
...
// static
void CharReaderBuilder::strictMode(MJson::Value* settings) {
...
// static
void CharReaderBuilder::setDefaults(MJson::Value* settings) {
