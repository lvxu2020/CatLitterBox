...
public:
   ...
   */
    ...
    /// \see MJson::operator>>(std::istream&, MJson::Value&).
...
public:
    // Note: We use a MJson::Value so that we can add data-members to this class
   ...
   */
    bool validate(MJson::Value* invalid) const;
   ...
   * \pre 'settings' != NULL (but MJson::null is fine)
   * \remark Defaults:
   * \snippet src/lib_json/json_reader.cpp CharReaderBuilderDefaults
   */
    static void setDefaults(MJson::Value* settings);
    /** Same as old Features::strictMode().
   * \pre 'settings' != NULL (but MJson::null is fine)
   * \remark Defaults:
   * \snippet src/lib_json/json_reader.cpp CharReaderBuilderStrictMode
   */
    static void strictMode(MJson::Value* settings);
};
